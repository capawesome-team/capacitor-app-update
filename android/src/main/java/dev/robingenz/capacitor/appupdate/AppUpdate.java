...
public class AppUpdate extends Plugin {
    ...
    public void performImmediateUpdate(PluginCall call) {
        ...
        saveCall(call);
        try {
            this.appUpdateManager.startUpdateFlowForResult(this.appUpdateInfo, AppUpdateType.IMMEDIATE, getActivity(), AppUpdate.REQUEST_IMMEDIATE_UPDATE);
    ...
    public void startFlexibleUpdate(PluginCall call) {
        ...
        try {
            ...
            this.appUpdateManager.startUpdateFlowForResult(this.appUpdateInfo, AppUpdateType.FLEXIBLE, getActivity(), AppUpdate.REQUEST_FLEXIBLE_UPDATE);
        } catch (IntentSender.SendIntentException e) {
            call.reject(e.getMessage());
        }
    }
